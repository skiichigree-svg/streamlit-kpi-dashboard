...
raw_data AS (
    ...
    FROM
        reports.PerformanceReport perf
            ...
            LEFT JOIN provisioning2.PrivateContract pc
                ON perf.PrivateContractId = pc.PrivateContractId
            LEFT JOIN provisioning2.CampaignFlight cf
                ON perf.CampaignFlightId = cf.CampaignFlightId
    WHERE
        perf.PartnerId IN (
...
Select * from provisioning2.PrivateContract limit 10;